...
return [
    ...
    | proporcionados por el corredor de contraseñas para un intento fallido de actualización de
    | contraseña, como un token no válido o una nueva contraseña no válida.
    |
    */
