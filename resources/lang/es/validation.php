...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma contienen los mensajes de error predeterminados utilizados
    | por la clase de validador. Algunas de estas reglas tienen múltiples versiones tales
