...
class OneMissClass extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject(ucfirst(mb_strtolower($this->student->Primer_nombre, 'UTF-8')).', no asististe a clase ¿qué pasó?')
            ->view('emails.q10.oneMissClass',
