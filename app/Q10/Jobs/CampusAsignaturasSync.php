...
class CampusAsignaturasSync implements ShouldQueue
{
    ...
    public function handle(Q10API $httpClient)
    {
        ...
        $response = $httpClient->get_page('asignaturas', [
            'headers' => [
